...
def parse_args():
    ...
    parser.add_argument('config', default='/mnt/mars-beta/tochukwu/maestro/maestro_code/mmrotate/configs/rotated_faster_rcnn/rotated_faster_rcnn_r50_fpn_1x_dota_le90.py', help='train config file path')
